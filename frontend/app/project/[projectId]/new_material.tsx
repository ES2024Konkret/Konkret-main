...
export default function NewMaterial() {
    ...
    async function createMaterial(type: string, cust: number, quantity: number) {
    ...
    const handleSubmit = () => {
        ...
        createMaterial(type, numericCust, parseFloat(quantity));
    };
            ...
            <ImageBackground
                ...
                <View style={styles.employeeContainer}>
                    <View style={styles.textIconContainer}>
                        <View>
                            <Text style={styles.textTitle}>Receber</Text>
                    ...
                    <Pressable style={[material_styles.formButton]} onPress={handleSubmit}>
                        <Text style={material_styles.textButton}>Adicionar</Text>
                    </Pressable>
                </View>
            </ImageBackground>
        </View>
